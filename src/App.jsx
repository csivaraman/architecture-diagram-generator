                                            ...
                                            <>
                                                ...
                                                {connectionData.map(cd => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            {/* Label background — sized to exactly cover the label box + thin border.
                                                               Uses the visible label rect only (no extra masking rect) to avoid
                                                               hiding connector lines from OTHER connections that pass through this area. */}
                                                            <rect
                                                                x={-hw - 2}
                                                                y={-hh - 2}
